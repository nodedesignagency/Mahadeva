 ...
 *
 * Lucide dropped its brand icons in v1 (trademark reasons), and pulling in a
 * second icon package for three glyphs is not worth the dependency. These are
 * plain inline SVG paths — no runtime cost, no bundle beyond the markup.
 *
 * They inherit `currentColor` and size from the caller, so they style exactly
