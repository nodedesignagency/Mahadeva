 ...
 *
 * The reasoning behind each rule is in AGENTS.md, under "The wipe and the
 * preloader are one handover, in this order". If one of these fails, that is
 * the thing to read. Do not edit this file to agree with the code: every rule
 * here was added after someone changed the code for a good reason and broke
 * something a reader could see and a build could not.
 */
